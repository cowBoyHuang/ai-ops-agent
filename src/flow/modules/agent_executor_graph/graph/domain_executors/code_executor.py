...
_ALLOWED_TOOLS = ["searchMethod", "locateCode", "analyzeCodeFromLogs", "analyzeCodeForBusinessConsult"]
...
def run(payload: dict[str, Any]) -> dict[str, Any]:
    ...
    result = execute_domain_goal(
        ...
        prompt_name="code_executor_react_system_prompt.txt",
